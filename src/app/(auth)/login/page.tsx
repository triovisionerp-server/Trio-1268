...
const FALLBACK_USERS: Record<string, { password: string; role: string; name: string }> = {
  ...
  sunil: { password: 'Trio@2015', role: 'md', name: 'Sunil yallapragda' },
  nandan: { password: 'Trio@2015', role: 'md', name: 'Nandan Reddy' },
  parthiban: { password: 'Trio@2015', role: 'md', name: 'Parthiban Selvan' },
  // Other roles
